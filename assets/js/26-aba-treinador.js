...
function renderTreinador(){
  ...
  document.getElementById('treinadorCards').innerHTML=_listaT.map(t=>{
    ...
    return `<div class="person-card" onclick="openTreinadorDetail('${t}')" style="position:relative;--c-cor:${cor};">
      ...
      <div class="pc-name" data-cor="${cor}" style="font-size:15px;color:${cor};text-shadow:0 1px 4px rgba(0,0,0,.55);">${t.toUpperCase()}</div>
...
function _renderTreinadorDetail(t){
  ...
  document.getElementById('treinadorDetailSub').innerHTML=
    ...
    +'<div style="font-size:13px;font-weight:700;color:var(--pago);font-family:\'DM Mono\',monospace;white-space:nowrap;">'+formatVal(pago)+'</div>'
    ...
    +'<div style="font-size:13px;font-weight:700;color:var(--amber);font-family:\'DM Mono\',monospace;white-space:nowrap;">'+formatVal(aberto)+'</div>'
