...
(function(){
  ...
  function _injectCss(){
    ...
    var css = ''
      ...
      + '.trap-poster .trap-poster-grad{ position:absolute; inset:0; background:linear-gradient(transparent 52%, rgba(3,8,18,.30) 72%, rgba(3,8,18,.62)); }'
      + '.trap-poster-cap{ position:absolute; left:0; right:0; bottom:0; padding:14px 14px 16px; z-index:2; }'
      + '.trap-poster-prod{ font-size:20px; font-weight:900; color:#fff; line-height:1.1; text-transform:uppercase; text-shadow:0 1px 3px rgba(0,0,0,.8), 0 2px 10px rgba(0,0,0,.6); }'
      + '.trap-poster-tit{ font-size:10.5px; color:#eaf0f6; margin-top:5px; line-height:1.35; text-shadow:0 1px 3px rgba(0,0,0,.85); }'
