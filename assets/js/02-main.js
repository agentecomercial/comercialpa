...
/* ─── Prólogo comum dos layouts A–G (Fase 1.D) ───
   Retorna {el, ano, mesMap} ou null se o container não existe.
   ano = turmas filtradas pelo ano atual (_tturmasAnoAtual).
   mesMap = { 1: [...turmas], 2: [...turmas], ..., 12: [...turmas] }.
   Atualiza a barra de anos como efeito colateral. */
  ...
  _carregarTurmaGlobalAtiva(function(){
    ...
    Promise.all([
      ...
      if(fbTurmas&&typeof fbTurmas==='object'&&Object.keys(fbTurmas).length>0){
        ...
        // Migrar automaticamente para turmas/ ao renderizar
